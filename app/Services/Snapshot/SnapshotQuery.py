...
class SnapshotQuery:
    ...
    def search_perhitungan(cls, server_key, search_kode=None, search_nama=None, divisi=None,
                           kategori=None, merk=None, limit=None, offset=None,
                           sort_by=None, sort_order='asc'):
            data = cls._filter_perhitungan_memory(server_key, search_kode, search_nama, divisi, kategori, merk)
            return cls._build_result(data, source='memory_perhitungan', limit=limit, offset=offset, sort_by=sort_by, sort_order=sort_order)

    @classmethod
    def _filter_perhitungan_memory(cls, server_key, search_kode=None, search_nama=None, divisi=None,
                                   kategori=None, merk=None):
            data = SnapshotState._perhitungan_cache.get(server_key, [])
            filtered = []
